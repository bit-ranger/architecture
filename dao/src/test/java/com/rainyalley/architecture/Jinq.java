...
import com.rainyalley.architecture.entity.Customer;
import com.rainyalley.architecture.entity.Item;
import com.rainyalley.architecture.entity.ItemType;
import com.rainyalley.architecture.entity.Lineorder;
...
@SpringBootTest(
        classes = {DaoTestApplication.class}
)
public class Jinq
{
    ...
    public  void test() throws Exception
    {
        ...
        properties.put(SCHEMA_GENERATION_DROP_AND_CREATE_ACTION, "drop-and-create");
        properties.put(SCHEMA_GENERATION_CREATE_DATABASE_SCHEMAS, true);
        properties.put(BATCH_WRITING, "JDBC");

        // Configure Jinq for the given JPA database connection
        entityManagerFactory = Persistence.createEntityManagerFactory("JPATest", properties);
